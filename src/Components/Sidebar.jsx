      ...
      >
        <ul className="navbar-nav">
          <li className="nav-item">
            <Link className="nav-link  active" to={"/"}>
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-house" style={{ fontSize: "17px" }}>
                  {" "}
                </i>
                <title>shop </title>
          ...
          <li className="nav-item">
            ...
            >
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-user" style={{ fontSize: "17px" }}></i>
                <title>office</title>
                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                  <g
          ...
          <li className="nav-item">
            <Link className="nav-link  active" to={"/Catégories"}>
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i
              ...
              <span className="nav-link-text ms-1">Catégories</span>
            </Link>
            <br/>
          </li>
          <li className="nav-item">
            <Link className="nav-link  active" to={"/avis"}>
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i
            ...
            <div className="nav-link  active" >
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <button  onClick={handleLogout} className="nav-link  " >
                    <i style={{ fontSize: "17px" }} class="fa-solid fa-arrow-right-to-bracket"></i>
                  </button>
